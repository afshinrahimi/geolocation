...
if __name__ == '__main__':
    pass
    #mlp(X_train, Y_train, X_dev, Y_dev, X_test, Y_test, n_epochs=n_epochs, batch_size=batch_size, init_parameters=None, complete_prob=complete_prob, add_hidden=add_hiden, regul_coefs=_coefs, save_results=False, hidden_layer_size=_hidden_layer_size, drop_out=True, drop_out_coefs=[0.5, 0.5])            
